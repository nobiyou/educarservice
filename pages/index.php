                ...
                <div class="sidebar-nav navbar-collapse">
					...
					<li>
                        ...
                        <li>
                         ...
                         <li>
                            <a href="?menu=report-car" <?php if($menu == "report-car"){echo 'class="active alert-danger"';} ?>><i class="fa fa-bar-chart fa-fw"></i> สถิติการใช้รถยนต์</a>
                        </li>
                         <li>
                            <a href="?menu=report-driver" <?php if($menu == "report-driver"){echo 'class="active alert-danger"';} ?>><i class="fa fa-bar-chart fa-fw"></i> สถิติพนักงานขับรถยนต์</a>
                        </li>                       
